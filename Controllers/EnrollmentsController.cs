...
namespace schoolmanagement.Controllers
{
    ...
    public class EnrollmentsController : Controller
    {
        ...
        {
            var schoolmanagement = _context.Enrollments.Include(e => e.Class).Include(e => e.Student);

            return View(await schoolmanagement.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var enrollment = await _context.Enrollments.Include(e => e.Class).Include(e => e.Student).FirstOrDefaultAsync(m => m.Id == id);
