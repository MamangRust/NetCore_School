...
namespace schoolmanagement.Controllers
{
    ...
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var @class = await _context.Classes.Include(q => q.Course).Include(q => q.Lecturer).FirstOrDefaultAsync(m => m.Id == id);
        ...
        {
            var @class = await _context.Classes.Include(q => q.Course).Include(q => q.Lecturer).Include(q => q.Enrollments).ThenInclude(q => q.Student).FirstOrDefaultAsync(m => m.Id == classId);
